...
public class Lab_1_Display extends UIComponent{
    ...
    private void addActors() {
        ...
        Image lab = new Image(ServiceLocator.getResourceService().getAsset("images/map/LAB/lab 1.png", Texture.class));
