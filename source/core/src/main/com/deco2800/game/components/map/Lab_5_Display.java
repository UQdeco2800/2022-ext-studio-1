 ...
 */
public class Lab_5_Display extends UIComponent{
    private static final Logger logger = LoggerFactory.getLogger(Lab_5_Display.class);
    private static final float Z_INDEX = 2f;
    private Table table;
    private final GdxGame game;

    public Lab_5_Display(GdxGame game) {
        super();
        this.game = game;
    }
    ...
    private void addActors() {
        ...
        Image lab = new Image(ServiceLocator.getResourceService().getAsset("images/map/LAB/lab 5.png", Texture.class));
